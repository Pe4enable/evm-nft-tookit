...
const main = async () => {
  ...
  const buffalo = {
    ...
    external_url: "https://donft.io", // <-- this can link to a page for the specific file too
    image: "https://drive.google.com/uc?id=1g-3Ugf9-op4HB5ww2kikvyVHsAwd_aYU",
    name: "Buffalo",
    attributes: [
      {
  ...
  const zebra = {
    ...
    external_url: "https://donft.io", // <-- this can link to a page for the specific file too
    image: "https://drive.google.com/uc?id=1WnS9oQUu6CNdC4_n9x9UumsMBAcAM0Ma",
    name: "Zebra",
    attributes: [
      {
        trait_type: "BackgroundColor",
  ...
  const rhino = {
    ...
    external_url: "https://donft.io", // <-- this can link to a page for the specific file too
    image: "https://drive.google.com/uc?id=1U3fDx6tnYADfj60dKlqtPdHxtPvbX13p",
    name: "Rhino",
    attributes: [
      {
        trait_type: "BackgroundColor",
