...
const STARTING_JSON = {
  ...
  image: "https://drive.google.com/uc?id=1g-3Ugf9-op4HB5ww2kikvyVHsAwd_aYU/view?usp=sharing",
  name: "Buffalo",
  attributes: [
    {
  ...
  */
  ...
  const json = {
    1: {
      ...
      image: "https://drive.google.com/uc?id=17TqIxT5qBwjJ_ZzIqA2QKniNgI83MikC",
      name: "Buffalo",
      attributes: [
        {
          trait_type: "BackgroundColor",
